...
imagesList.classList.add('gallery-list');

const addGallery = images.map(({ url, alt }) => {
  return `<li> <img src="${url}" alt="${alt}"> </li>`
}).join('');

imagesList.insertAdjacentHTML('afterbegin', addGallery);
imagesList.querySelectorAll('li').forEach(item => item.classList.add('gallery-item'));
